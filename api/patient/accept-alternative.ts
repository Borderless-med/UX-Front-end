// ============================================
// PATIENT RESPONSE: ACCEPT ALTERNATIVE SLOT
// URL: /api/patient/accept-alternative?ref=APT-xxx&slot=0&token=xxx
// Updates booking with chosen alternative, confirms appointment
// ============================================
...
export default async function handler(
  ...
  try {
    ...
    console.error('ACCEPT ALTERNATIVE ENDPOINT ERROR:', error);
    
    await sendAdminAlert(
      'Accept Alternative Error',
      'Unexpected error in accept-alternative endpoint',
      { 
        query: req.query, 
    ...
    return res.status(500).send(`
      <html>
        ...
        <body style="font-family: Arial; padding: 40px; text-align: center;">
          ...
          <p style="color: #6b7280; margin-top: 20px;">Please contact: contact@orachope.org</p>
        </body>
      </html>
    `);
  }
