...
const IframeAwareDialog: React.FC<IframeAwareDialogProps> = ({
  ...
  if (useIframeMode) {
    ...
    return (
      <div 
        className="fixed inset-0 z-[60] bg-black/50 flex justify-center pt-32 pb-8 px-4"
        onClick={(e) => {
      ...
      >
        <div 
          ref={dialogRef}
          className={cn(
            "bg-background border border-border rounded-lg shadow-lg w-full max-w-4xl max-h-[calc(100vh-8rem)] overflow-y-auto relative",
            className
          )}
