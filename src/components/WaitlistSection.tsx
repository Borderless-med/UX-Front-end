    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          ai_chatbot_interest: formData.aiChatbotInterest,
          clinic_analytics_interest: formData.clinicAnalyticsInterest,
        ...
        <Card className="shadow-xl border-blue-light bg-white">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* AI Features Interest Section */}
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-200 rounded-xl p-6 space-y-4 shadow-sm">
                <div className="text-sm text-gray-700">
                  <h4 className="font-bold text-gray-900 mb-3 text-base">🤖 AI Features Interest (Optional)</h4>
                  
                  <div className="bg-white/70 rounded-lg p-4 mb-4 border border-purple-100">
                    <p className="font-semibold text-purple-800 mb-2">Get notified about our upcoming AI features:</p>
                    <ul className="list-disc pl-5 space-y-1 text-purple-700">
                      <li>24/7 AI Dental Assistant for instant booking & recommendations</li>
                      <li>Advanced analytics dashboard with real-time clinic insights</li>
                      <li>Early access to beta testing and exclusive features</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <Checkbox 
                      id="ai-chatbot-interest"
                      checked={formData.aiChatbotInterest}
                      onCheckedChange={(checked) => handleInputChange('aiChatbotInterest', checked as boolean)}
                      className="mt-1 border-2 border-purple-400 data-[state=checked]:bg-purple-500 data-[state=checked]:border-purple-500"
                    />
                    <label htmlFor="ai-chatbot-interest" className="text-sm text-gray-800 leading-relaxed cursor-pointer">
                      <span className="font-semibold text-purple-800">Notify me when AI Chatbot launches</span>
                      <br />
                      <span className="text-xs text-gray-600">
                        Get early access to our AI assistant for instant booking & personalized recommendations
                      </span>
                    </label>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <Checkbox 
                      id="clinic-analytics-interest"
                      checked={formData.clinicAnalyticsInterest}
                      onCheckedChange={(checked) => handleInputChange('clinicAnalyticsInterest', checked as boolean)}
                      className="mt-1 border-2 border-purple-400 data-[state=checked]:bg-purple-500 data-[state=checked]:border-purple-500"
                    />
                    <label htmlFor="clinic-analytics-interest" className="text-sm text-gray-800 leading-relaxed cursor-pointer">
                      <span className="font-semibold text-purple-800">I'm interested in clinic analytics insights</span>
                      <br />
                      <span className="text-xs text-gray-600">
                        For dental partners - get notified about our advanced analytics dashboard
                      </span>
                    </label>
                  </div>
                </div>
                
                <div className="text-xs text-gray-500 bg-white/60 rounded-lg p-3 border border-purple-100">
                  <p className="font-medium">Note:</p>
                  <p>These preferences are optional and help us notify you about features most relevant to your interests. You can update these preferences at any time.</p>
                </div>
              </div>
