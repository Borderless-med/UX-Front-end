  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">Select the approach that works best for you</p>
      </div>
      
      <div className="grid md:grid-cols-2 gap-10">
        {/* AI Concierge Card */}
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-12 border-2 border-blue-200 hover:border-blue-300 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex flex-col">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-700 mb-6">Let our AI assistant guide you through clinic selection with advanced sentiment analysis and personalized recommendations</p>
            <div className="text-base text-blue-700 font-semibold mb-6">Perfect for: First-time patients, those seeking guidance</div>
          </div>
        ...
        {/* Manual Process Card */}
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-12 border-2 border-gray-200 hover:border-gray-300 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex flex-col">
          <div className="text-center mb-8">
            ...
            <div className="text-base text-gray-700 font-semibold mb-6">Perfect for: Experienced patients, those who prefer control</div>
          </div>
