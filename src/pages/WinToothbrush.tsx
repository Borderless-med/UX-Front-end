        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-5 gap-6 items-stretch">
            ...
            <div className="lg:col-span-3 w-full">
              ...
              {/* MOBILE ONLY: Headline + Compact Value Props */}
              <div className="lg:hidden mb-3">
                ...
                {/* Compact Mobile Value Props - Horizontal Icons */}
                <div className="flex justify-around items-center py-3 px-2 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg mb-3">
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <span className="text-[10px] font-semibold text-gray-700">Save $</span>
                  </div>
                  <div className="flex flex-col items-center text-center">
                    <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mb-1">
                      <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-[10px] font-semibold text-gray-700">AI Guide</span>
                  </div>
                </div>
              </div>
              ...
              {/* MOBILE ONLY: Toothbrush Image Below Form */}
              <div className="lg:hidden mt-4">
                <div className="relative">
                  <div className="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-2xl p-3 shadow-lg w-full">
                    <img
                      src="/Xiami- mijia T200 toothbrush_v2.jpg"
                      alt="Xiaomi Mijia T200 Electric Toothbrush"
                ...
                {/* Product Benefits - Mobile Compact */}
                <div className="space-y-1 mt-3 px-2">
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-3 w-3 text-blue-600 flex-shrink-0" />
                    <p className="text-[10px] text-gray-700"><strong>31,000 vibrations/min</strong> for deep cleaning</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-3 w-3 text-blue-600 flex-shrink-0" />
                    <p className="text-[10px] text-gray-700"><strong>Dual Modes</strong> with antibacterial bristles</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-3 w-3 text-blue-600 flex-shrink-0" />
                    <p className="text-[10px] text-gray-700"><strong>25-Day Battery</strong> with USB-C charging</p>
                  </div>
                </div>
              </div>
