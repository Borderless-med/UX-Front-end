...
import { Cookie, Settings, Clock, Shield } from 'lucide-react';
      ...
      <div className="pt-32 px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-sm border-gray-200/60">
              <CardHeader>
                <CardTitle className="text-xl text-gray-900">Types of Cookies We Use</CardTitle>
              </CardHeader>
            ...
            <Card className="shadow-sm border-gray-200/60">
              <CardHeader>
                <CardTitle className="text-xl text-gray-900">Your Cookie Rights</CardTitle>
              </CardHeader>
              <CardContent className="text-gray-700 space-y-4 leading-relaxed">
                <p>
            ...
            <Card className="shadow-sm border-gray-200/60">
              <CardHeader>
                <CardTitle className="text-xl text-gray-900">Questions About Cookies</CardTitle>
              </CardHeader>
