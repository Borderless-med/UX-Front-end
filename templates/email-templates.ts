    ...
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px;">
          ...
          <div style="background-color: #f0fdf4; border: 2px solid #22c55e; padding: 20px; border-radius: 6px; margin: 20px 0;">
          ...
          <div style="background-color: #eff6ff; padding: 15px; border-radius: 6px; margin: 20px 0;">
            ...
            <a href="${data.google_maps_url}" style="display: inline-block; background: #2563eb; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: 600; margin-top: 10px;">View on Google Maps</a>
          </div>
          ...
          <div style="text-align: center; margin: 30px 0;">
            ...
            <a href="${data.cancel_url}" style="display: inline-block; background: #dc2626; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: 600;">Cancel This Booking</a>
          </div>
        </div>
  ...
  html: `
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px;">
        ...
        <div style="background-color: #f8fafc; padding: 12px; border-left: 4px solid #dc2626; margin: 0 0 20px;">
        ...
        <div style="background-color: #f0fdf4; padding: 15px; border-radius: 6px; margin: 0 0 20px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${data.reject_url}" style="display: inline-block; background: #6b7280; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 5px;">❌ No Thanks, I'll Find Another Clinic</a>
        </div>
  ...
  html: `
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px;">
        ...
        <div style="background-color: #fef2f2; padding: 15px; border-left: 4px solid #dc2626; margin: 0 0 20px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://orachope.org/clinics?treatment=${encodeURIComponent(data.treatment_type || '')}" style="display: inline-block; background: #2563eb; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 5px;">🔍 BROWSE OTHER CLINICS</a>
          <a href="https://wa.me/6581926158" style="display: inline-block; background: #22c55e; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 5px;">💬 CONTACT SUPPORT</a>
        </div>
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px;">
          ...
          <div style="background-color: #fff7ed; border: 2px solid #f59e0b; padding: 20px; border-radius: 6px; margin: 20px 0;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${data.clinic_card_url}" style="display: inline-block; background: #2563eb; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 5px;">📍 VIEW CLINIC DETAILS<br><span style="font-size: 12px; opacity: 0.9;">(Map & Directions)</span></a>
            <a href="${data.google_maps_url}" style="display: inline-block; background: #22c55e; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 5px;">💬 CONTACT CLINIC</a>
          </div>
...
const alternativeSlotAcceptedClinic: EmailTemplateFunction = (data) => ({
  ...
  html: `
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px;">
        <div style="background-color: #22c55e; color: #ffffff; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
