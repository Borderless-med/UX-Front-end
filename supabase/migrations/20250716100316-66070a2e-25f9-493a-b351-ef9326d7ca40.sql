-- Fix remaining vector functions with security settings
-- Fix match_clinics function (Keep existing signature, just add SET search_path)
...
-- Fix match_documents function (Keep existing signature, just add SET search_path)
