...
-- Fix log_consent function - add SET search_path = ''
...
-- Fix has_valid_consent function - add SET search_path = ''
...
-- Fix audit_data_access function - add SET search_path = ''
...
-- Fix match_documents function - add SET search_path = ''
