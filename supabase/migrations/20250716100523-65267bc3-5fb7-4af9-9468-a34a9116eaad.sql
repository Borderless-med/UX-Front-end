-- Try to fix the vector functions with a different search path approach
-- The vector extension might be in a different schema

-- Update match_clinics function with vector schema included
...
-- Update match_documents function with vector schema included
